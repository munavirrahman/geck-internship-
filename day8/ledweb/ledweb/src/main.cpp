...
#define WIFI_SSID "Galaxy A04"
#define WIFI_PASSWORD "12345678"

// 2. Direct JSON Endpoint URL (Notice the .json at the end)
const char* firebase_url = "https://eps32smarthome-default-rtdb.firebaseio.com/led_state.json"; // Replace with your Firebase Realtime Database URL and node
